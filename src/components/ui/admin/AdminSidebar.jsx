                        ...
                        <ul className="mb-6 flex flex-col gap-1.5">
                                        ...
                                        <React.Fragment>
                                            ...
                                            >
                                                <ul className="mt-4 mb-5.5 flex flex-col gap-2.5 pl-6">
                                                    <li>
                                                        <NavLink
                                                            to="/admin/quan-ly-vac-xin/danh-muc"
                                                            className={({ isActive }) =>
                                                                'group relative flex items-center gap-2.5 rounded-md px-4 font-medium text-bodydark2 duration-300 ease-in-out hover:text-white ' +
                                                                (isActive && '!text-white')
                                                            }
                                                    ...
                                                    <li>
                                                        <NavLink
                                                            to="/admin/quan-ly-vac-xin/goi-vac-xin"
                                                            className={({ isActive }) =>
                                                                'group relative flex items-center gap-2.5 rounded-md px-4 font-medium text-bodydark2 duration-300 ease-in-out hover:text-white ' +
                                                                (isActive && '!text-white')
                                                            }
                            ...
                            <li>
                                ...
                                >
                                    ...
                                    >
                                        <path
                                            d="M20 2H4C2.897 2 2 2.897 2 4V18C2 19.103 2.897 20 4 20H7V18H4V6H20V18H17V20H20C21.103 20 22 19.103 22 18V4C22 2.897 21.103 2 20 2ZM6 10H10V12H6V10ZM14 10H18V12H14V10ZM6 14H10V16H6V14ZM14 14H18V16H14V14ZM13 18H11V22H13V18Z"
                                            fill=""
                                        />
                                    </svg>
                                    Quản lý nhập hàng
