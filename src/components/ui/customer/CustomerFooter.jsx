...
export const CustomerFooter = () => {
    return (
        <footer className="border-t-2 border-base-300 mx-5 pt-5">
            <div>
                <div className="flex flex-col md:flex-row justify-center items-center space-y-10 md:space-y-0 md:space-x-10">
                    <div className="">
                        <img className="w-40 md:w-56" src="/images/logo.png" alt="Logo"></img>
                    </div>
                ...
                <div className="border-t-2 border-gray-300 mt-10 mx-auto w-full md:w-2/3"></div>

                <div className="py-3 text-sm text-center dark:text-gray-600 font-bold">
