...
export const AppointmentForm = () => {
    ...
    const onSubmit = (data) => {
        ...
        try {
            appointmentService
                .createAppointmentWithOutCustCode(formattedData)
                .then((response) => setApptResponse(response.data))
                .catch((err) => console.log('Create Appointment Failed'))

            console.log(apptResponse)
            if (apptResponse.code === 1000) {
    ...
    return (
        <div>
            ...
            <div className="mt-5 flex flex-row space-x-5 w-full">
                {isCustomer == 0 ? (
                    <form className=" max-w-full" onSubmit={handleSubmit(onSubmit)}>
                        ...
                        <div className="relative z-0 w-full mb-5 group space-x-2">
                            ...
                            <DatePicker
                                ...
                                onChange={(date) =>
                                    setValue('appointmentInjectionDate', date?.toDate() || null, {
                                        shouldValidate: true,
                                    })
                                }
                            />
                    ...
                    <form className="max-w-full">
                        ...
                        <div className="relative z-0 w-125 mb-5 group mt-5">
                            <input
                                className="block py-2.5 px-0 w-full  text-sm text-gray-900 bg-transparent border-0 border-b-2 border-gray-300 appearance-none dark:text-white dark:border-gray-600 dark:focus:border-blue-500 focus:outline-none focus:ring-0 focus:border-blue-600 peer"
                                placeholder=""
                                required
                ...
                <div className="flex-1 max-w-full">
                    ...
                    {errors.appointmentBatchDetailId && (
                        <div className="text-red-500 text-sm w-full mt-2">
                            {errors.appointmentBatchDetailId.message || 'Bạn chưa chọn vắc xin'}
                        </div>
                    )}
                    ...
                    <div className="collapse collapse-arrow  bg-base-200 mt-5">
                        <input type="checkbox" />
                        <div className="collapse-title text-lg font-medium">Gói vắc xin</div>
                        <div className="collapse-content">
